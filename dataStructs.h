...
class dataStructs{
    public://////////////////////////////////////////////////////////////////////////////////
        ...
        struct {
            string p_type[4] = {"01", "00", "00", "00"};
            string p_flags64[4] = {"05", "00", "00", "00"}; // 64bit position
            string p_offset[8] = {"40", "00", "00", "00", "00", "00", "00", "00"};
            string p_vaddr[8] = {"00", "00", "00", "08", "00", "00", "00", "00"};
            string p_paddr[8] = {"00", "00", "00", "08", "00", "00", "00", "00"};
            string p_filesz[8] = {"90", "00", "00", "00", "00", "00", "00", "00"};
            string p_memsz[8] = {"90", "00", "00", "00", "00", "00", "00", "00"};
